...
// __TYPE_DECL_END
// __TYPE_DECL_START: 3D51FBA3492595876C74E79B03C0F00E
    namespace Game.StarterContent.BP_Base {
        class BP_Base_C extends UE.Pawn {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            DefaultSceneRoot: UE.SceneComponent;
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): BP_Base_C;
            static Load(InName: string): BP_Base_C;
        
            __tid_BP_Base_C_0__: boolean;
        }
        
    }

// __TYPE_DECL_END
// __TYPE_DECL_START: 2872475D4187FA9F1F6992ABF506734A
    namespace Game.StarterContent.BP_BaseDerive {
        class BP_BaseDerive_C extends UE.Game.StarterContent.BP_Base.BP_Base_C {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): BP_BaseDerive_C;
            static Load(InName: string): BP_BaseDerive_C;
        
            __tid_BP_BaseDerive_C_0__: boolean;
        }
        
    }

// __TYPE_DECL_END
// __TYPE_DECL_START: 02540D8A42A601572BDF81A85F39EE20
    namespace Game.StarterContent.BP_GameModeMixin {
        class BP_GameModeMixin_C extends UE.GameModeBase {
            constructor(Outer?: Object, Name?: string, ObjectFlags?: number);
            DefaultSceneRoot: UE.SceneComponent;
            static StaticClass(): Class;
            static Find(OrigInName: string, Outer?: Object): BP_GameModeMixin_C;
            static Load(InName: string): BP_GameModeMixin_C;
        
            __tid_BP_GameModeMixin_C_0__: boolean;
        }
